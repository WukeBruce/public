...
/* NestLock API*/
int32_t GxCore_NestCreate      (handle_t *nest_id);
int32_t GxCore_NestDelete      (handle_t nest_id);
int32_t GxCore_NestUnlock      (handle_t nest_id);
int32_t GxCore_NestTrylock     (handle_t nest_id);
int32_t GxCore_NestLock        (handle_t nest_id);
...
/*
 * GxCore_PrintSwitch(sw)
 *	sw = true: on
 *	sw = false: off
*/
void GxCore_PrintSwitch(bool sw);
...
/* CMDLINE Mem Info API */
int GxCore_MemInfoGet(char *name, struct Gx_Mem_Info *info);
