 ...
 *
 * $Id: encoding.c,v 1.4 1998/11/01 19:34:25 veillard Exp $
 *
 ...
 */
int
GXisolat1ToUTF8(unsigned char* out, int outlen, unsigned char* in, int inlen)
{
 ...
 */
int
GXUTF8Toisolat1(unsigned char* out, int outlen, unsigned char* in, int inlen)
{
    unsigned char* outstart= out;
    unsigned char* outend= out+outlen;
    unsigned char* inend= in+inlen;
 ...
 */
int
GXUTF16ToUTF8(unsigned char* out, int outlen, unsigned short* in, int inlen)
{
    unsigned char* outstart= out;
    unsigned char* outend= out+outlen;
 ...
 */
int
GXUTF8ToUTF16(unsigned short* out, int outlen, unsigned char* in, int inlen)
{
